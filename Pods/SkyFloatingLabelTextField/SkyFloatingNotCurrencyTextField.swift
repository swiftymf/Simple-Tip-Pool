 ...
 */
@IBDesignable
open class SkyFloatingNotCurrencyTextField: UITextField { // swiftlint:disable:this type_body_length
  ...
  override public init(frame: CGRect) {
    ...
    init_SkyFloatingNotCurrencyTextField()
  }
  ...
  fileprivate final func init_SkyFloatingNotCurrencyTextField() {
    borderStyle = .none
    createTitleLabel()
    createLineView()
    updateColors()
  ...
  fileprivate func addEditingChangedObserver() {
    self.addTarget(self, action: #selector(SkyFloatingNotCurrencyTextField.editingChanged), for: .editingChanged)
  }
